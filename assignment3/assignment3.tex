...
\noindent\textbf{Exercise 1.} \emph{Recreate this entire document.}\footnote{How meta.} \index{meta} \newline

\noindent\textbf{Exercise 2.} \emph{Create a new document containing a short description of three of your favorite books, papers, or other publications. Be sure to include a bibliog-raphy, created using \hologo{BibTeX}.} \index{BibTeX} \newline
...
Euler \index{Euler}proved many statements, such as
\begin{equation}
...
Euler's \index{Euler}original proof of Theorem 1 makes unjustified assumptions that infinite products and sums behave like finite products and sums, but interesting nonetheless and worth displaying.
...
% the following is formated incorrectly
