...
After first simplfying using the exponential and the natural log functions, L'Hopital's rule can be used to evaluate $ \lim_{x \to 2^-} (4-x)^{1/(2-x)}$% add acent over o in Hospital
...
\noindent \rule{\textwidth}{.1mm}
\end{document}
% & \leq \int_1^a |\frac{\sin(x)}{x}| \udx
% & \leq \int_1^a \frac{1}{x} \udx
% & = ln a.